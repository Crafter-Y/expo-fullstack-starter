import{j as i,r as S,V as C}from"./iframe-B9uuOGA6.js";import{t as E}from"./translation-keys-BvFbRUfI.js";import{F as d,a as o}from"./CategoryFormModal-DtBidQfS.js";import"./preload-helper-Zf8nSx-t.js";import"./Button-D3OpL1aQ.js";import"./useTranslation-CKsYuO2D.js";import"./index-D5Vn3TLA.js";import"./Divider-CyMuReAG.js";import"./ErrorMessage-B196fSAz.js";import"./FormTextInput-C5FkpzYC.js";import"./Ionicons-BkdL0UCY.js";import"./createIconSet-BR1XLBi8.js";const{expect:l,fn:u,userEvent:m,within:p}=__STORYBOOK_MODULE_TEST__,h={title:"todos/FormColorSelector",component:d,tags:["autodocs"],args:{onSelectColor:u()},argTypes:{label:E},render:e=>{const[t,c]=S.useState(e.selectedColor);return i.jsx(d,{...e,selectedColor:t,onSelectColor:a=>{c(a),e.onSelectColor(a)}})}},r={args:{label:"category.color",colors:o,selectedColor:o[0]},play:async({args:e,canvasElement:t})=>{const a=p(t).getAllByRole("radio");await m.click(a[1]),await l(e.onSelectColor).toHaveBeenCalledTimes(1),await l(e.onSelectColor).toHaveBeenCalledWith(o[1])}},n={args:{label:"category.color",colors:o,selectedColor:o[1],disabled:!0},play:async({args:e,canvasElement:t})=>{const a=p(t).getAllByRole("radio");await l(async()=>{await m.click(a[2])}).rejects.toThrow("pointer-events: none"),await l(e.onSelectColor).not.toHaveBeenCalled()}},s={args:{label:"category.color",colors:o,selectedColor:o[1]},decorators:[e=>i.jsx(C,{className:"max-w-xs",children:i.jsx(e,{})})]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
