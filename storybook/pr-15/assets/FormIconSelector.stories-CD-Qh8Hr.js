import{j as i,r as S,V as I}from"./iframe-B9uuOGA6.js";import{t as E}from"./translation-keys-BvFbRUfI.js";import{b as d,P as n}from"./CategoryFormModal-DtBidQfS.js";import"./preload-helper-Zf8nSx-t.js";import"./Button-D3OpL1aQ.js";import"./useTranslation-CKsYuO2D.js";import"./index-D5Vn3TLA.js";import"./Divider-CyMuReAG.js";import"./ErrorMessage-B196fSAz.js";import"./FormTextInput-C5FkpzYC.js";import"./Ionicons-BkdL0UCY.js";import"./createIconSet-BR1XLBi8.js";const{expect:r,fn:u,userEvent:m,within:p}=__STORYBOOK_MODULE_TEST__,N={title:"todos/FormIconSelector",component:d,tags:["autodocs"],args:{onSelectIcon:u()},argTypes:{label:E},render:e=>{const[o,l]=S.useState(e.selectedIcon);return i.jsx(d,{...e,selectedIcon:o,onSelectIcon:a=>{l(a),e.onSelectIcon(a)}})}},t={args:{label:"category.icon",icons:n,selectedIcon:n[0]},play:async({args:e,canvasElement:o})=>{const a=p(o).getAllByRole("radio");await m.click(a[1]),await r(e.onSelectIcon).toHaveBeenCalledTimes(1),await r(e.onSelectIcon).toHaveBeenCalledWith(n[1])}},c={args:{label:"category.icon",icons:n,selectedIcon:n[1],disabled:!0},play:async({args:e,canvasElement:o})=>{const a=p(o).getAllByRole("radio");await r(async()=>{await m.click(a[2])}).rejects.toThrow("pointer-events: none"),await r(e.onSelectIcon).not.toHaveBeenCalled()}},s={args:{label:"category.icon",icons:n,selectedIcon:n[1]},decorators:[e=>i.jsx(I,{className:"max-w-xs",children:i.jsx(e,{})})]};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    label: "category.icon",
    icons: PRESET_ICONS,
