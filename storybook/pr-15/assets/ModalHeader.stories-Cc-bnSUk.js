import{j as s,V as c}from"./iframe-B9uuOGA6.js";import{t as i}from"./translation-keys-BvFbRUfI.js";import{M as l}from"./ModalHeader-DDNxEso7.js";import"./preload-helper-Zf8nSx-t.js";import"./useTranslation-CKsYuO2D.js";import"./index-D5Vn3TLA.js";import"./Ionicons-BkdL0UCY.js";import"./createIconSet-BR1XLBi8.js";const{expect:m,fn:d,userEvent:p,within:g}=__STORYBOOK_MODULE_TEST__,E={title:"elements/ModalHeader",component:l,tags:["autodocs"],args:{onClose:d()},argTypes:{title:i},parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}}}},e={args:{title:"category.editCategory"},play:async({args:a,canvasElement:n})=>{const r=g(n).getByRole("button");await p.click(r),await m(a.onClose).toHaveBeenCalledTimes(1)}},t={args:{title:"todos.deleteConfirmation"}},o={args:{title:"todos.deleteConfirmation"},decorators:[a=>s.jsx(c,{className:"max-w-sm",children:s.jsx(a,{})})]};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
