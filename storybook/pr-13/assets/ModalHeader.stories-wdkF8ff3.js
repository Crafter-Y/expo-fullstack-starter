import{j as s,V as c}from"./iframe-B5wNKgXi.js";import{t as i}from"./translation-keys-DGWzY8ah.js";import{M as l}from"./ModalHeader-Cu78ciH2.js";import"./preload-helper-Zf8nSx-t.js";import"./useTranslation-DUqpV6O1.js";import"./index-CX4PDpOF.js";import"./Ionicons-qbNYLspj.js";import"./createIconSet-DiGDsuh_.js";const{expect:m,fn:d,userEvent:p,within:g}=__STORYBOOK_MODULE_TEST__,E={title:"elements/ModalHeader",component:l,tags:["autodocs"],args:{onClose:d()},argTypes:{title:i},parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}}}},e={args:{title:"category.editCategory"},play:async({args:a,canvasElement:n})=>{const r=g(n).getByRole("button");await p.click(r),await m(a.onClose).toHaveBeenCalledTimes(1)}},t={args:{title:"todos.deleteConfirmation"}},o={args:{title:"todos.deleteConfirmation"},decorators:[a=>s.jsx(c,{className:"max-w-sm",children:s.jsx(a,{})})]};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
