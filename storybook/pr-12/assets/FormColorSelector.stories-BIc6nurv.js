import{j as i,r as S,V as C}from"./iframe-CnBukXDy.js";import{t as E}from"./translation-keys-ChYLRgz2.js";import{F as d,a as o}from"./CategoryFormModal-D4I2pJPD.js";import"./preload-helper-Zf8nSx-t.js";import"./Button-BKZVwZAY.js";import"./useTranslation-CVELEUeQ.js";import"./index-Bbf6TjQq.js";import"./Divider-D7dFQH27.js";import"./ErrorMessage-CvWwMAti.js";import"./FormTextInput-BFtlpWRF.js";import"./Ionicons-rFyZZYhb.js";const{expect:l,fn:u,userEvent:m,within:p}=__STORYBOOK_MODULE_TEST__,L={title:"todos/FormColorSelector",component:d,tags:["autodocs"],args:{onSelectColor:u()},argTypes:{label:E},render:e=>{const[t,c]=S.useState(e.selectedColor);return i.jsx(d,{...e,selectedColor:t,onSelectColor:a=>{c(a),e.onSelectColor(a)}})}},r={args:{label:"category.color",colors:o,selectedColor:o[0]},play:async({args:e,canvasElement:t})=>{const a=p(t).getAllByRole("radio");await m.click(a[1]),await l(e.onSelectColor).toHaveBeenCalledTimes(1),await l(e.onSelectColor).toHaveBeenCalledWith(o[1])}},n={args:{label:"category.color",colors:o,selectedColor:o[1],disabled:!0},play:async({args:e,canvasElement:t})=>{const a=p(t).getAllByRole("radio");await l(async()=>{await m.click(a[2])}).rejects.toThrow("pointer-events: none"),await l(e.onSelectColor).not.toHaveBeenCalled()}},s={args:{label:"category.color",colors:o,selectedColor:o[1]},decorators:[e=>i.jsx(C,{className:"max-w-xs",children:i.jsx(e,{})})]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...s.parameters?.docs?.source}}};const h=["Default","Disabled","InSmallWindow"];export{r as Default,n as Disabled,s as InSmallWindow,h as __namedExportsOrder,L as default};
