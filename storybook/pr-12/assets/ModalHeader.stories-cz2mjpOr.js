import{j as s,V as c}from"./iframe-CnBukXDy.js";import{t as i}from"./translation-keys-ChYLRgz2.js";import{M as l}from"./ModalHeader-BKGvanSV.js";import"./preload-helper-Zf8nSx-t.js";import"./useTranslation-CVELEUeQ.js";import"./index-Bbf6TjQq.js";import"./Ionicons-rFyZZYhb.js";const{expect:m,fn:d,userEvent:p,within:g}=__STORYBOOK_MODULE_TEST__,B={title:"elements/ModalHeader",component:l,tags:["autodocs"],args:{onClose:d()},argTypes:{title:i},parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}}}},e={args:{title:"category.editCategory"},play:async({args:o,canvasElement:n})=>{const r=g(n).getByRole("button");await p.click(r),await m(o.onClose).toHaveBeenCalledTimes(1)}},t={args:{title:"todos.deleteConfirmation"}},a={args:{title:"todos.deleteConfirmation"},decorators:[o=>s.jsx(c,{className:"max-w-sm",children:s.jsx(o,{})})]};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
