import{j as i,r as S,V as I}from"./iframe-CvIt9pIp.js";import{t as E}from"./translation-keys-DZpkbaA8.js";import{a as d,b as n}from"./CategoryFormModal-DgIcwjjY.js";import"./preload-helper-Zf8nSx-t.js";import"./Button-BgsxUUjT.js";import"./useTranslation-B035vhT4.js";import"./Divider-B98GytsQ.js";import"./ErrorMessage-DDlhGp9B.js";import"./FormTextInput-Dk1iim8U.js";import"./Ionicons-CYGr9HTo.js";import"./createIconSet-D-GoVhaD.js";const{expect:r,fn:u,userEvent:m,within:p}=__STORYBOOK_MODULE_TEST__,b={title:"todos/FormIconSelector",component:d,tags:["autodocs"],args:{onSelectIcon:u()},argTypes:{label:E},render:e=>{const[o,l]=S.useState(e.selectedIcon);return i.jsx(d,{...e,selectedIcon:o,onSelectIcon:a=>{l(a),e.onSelectIcon(a)}})}},t={args:{label:"category.icon",icons:n,selectedIcon:n[0]},play:async({args:e,canvasElement:o})=>{const a=p(o).getAllByRole("radio");await m.click(a[1]),await r(e.onSelectIcon).toHaveBeenCalledTimes(1),await r(e.onSelectIcon).toHaveBeenCalledWith(n[1])}},c={args:{label:"category.icon",icons:n,selectedIcon:n[1],disabled:!0},play:async({args:e,canvasElement:o})=>{const a=p(o).getAllByRole("radio");await r(async()=>{await m.click(a[2])}).rejects.toThrow("pointer-events: none"),await r(e.onSelectIcon).not.toHaveBeenCalled()}},s={args:{label:"category.icon",icons:n,selectedIcon:n[1]},decorators:[e=>i.jsx(I,{className:"max-w-xs",children:i.jsx(e,{})})]};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    label: "category.icon",
    icons: PRESET_ICONS,
...
}`,...s.parameters?.docs?.source}}};const N=["Default","Disabled","InSmallWindow"];export{t as Default,c as Disabled,s as InSmallWindow,N as __namedExportsOrder,b as default};
