import{j as i,r as S,V as I}from"./iframe-C1YLhEZi.js";import{t as E}from"./translation-keys-Dpj7BitC.js";import{a as d,b as n}from"./CategoryFormModal-DHoVI4Lv.js";import"./preload-helper-Zf8nSx-t.js";import"./Button-C4yKxfL_.js";import"./useTranslation-Dm8a-IwT.js";import"./index-BXa_WnS3.js";import"./Divider-A3t-oiEu.js";import"./ErrorMessage-yhMqUtBF.js";import"./FormTextInput-DB8m13Ki.js";import"./Ionicons-BjVFwWMe.js";import"./createIconSet-BGfmYOKf.js";const{expect:r,fn:u,userEvent:m,within:p}=__STORYBOOK_MODULE_TEST__,N={title:"todos/FormIconSelector",component:d,tags:["autodocs"],args:{onSelectIcon:u()},argTypes:{label:E},render:e=>{const[o,l]=S.useState(e.selectedIcon);return i.jsx(d,{...e,selectedIcon:o,onSelectIcon:a=>{l(a),e.onSelectIcon(a)}})}},t={args:{label:"category.icon",icons:n,selectedIcon:n[0]},play:async({args:e,canvasElement:o})=>{const a=p(o).getAllByRole("radio");await m.click(a[1]),await r(e.onSelectIcon).toHaveBeenCalledTimes(1),await r(e.onSelectIcon).toHaveBeenCalledWith(n[1])}},c={args:{label:"category.icon",icons:n,selectedIcon:n[1],disabled:!0},play:async({args:e,canvasElement:o})=>{const a=p(o).getAllByRole("radio");await r(async()=>{await m.click(a[2])}).rejects.toThrow("pointer-events: none"),await r(e.onSelectIcon).not.toHaveBeenCalled()}},s={args:{label:"category.icon",icons:n,selectedIcon:n[1]},decorators:[e=>i.jsx(I,{className:"max-w-xs",children:i.jsx(e,{})})]};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    label: "category.icon",
    icons: PRESET_ICONS,
...
}`,...s.parameters?.docs?.source}}};const h=["Default","Disabled","InSmallWindow"];export{t as Default,c as Disabled,s as InSmallWindow,h as __namedExportsOrder,N as default};
