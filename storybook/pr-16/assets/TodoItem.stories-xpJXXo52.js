import{r as g,j as n,V as p,M as Y,T as w,P as F}from"./iframe-WWK3Gj28.js";import{B as H}from"./Button-6UjaK1rt.js";import{E as tt}from"./ErrorMessage-CDu4UP5P.js";import{F as z}from"./FormTextInput-E_zG1qFi.js";import{C as et}from"./CategorySelectorBadge-BAwOl8eC.js";import{M as nt}from"./MaterialIcons-oCT3Qub9.js";import"./preload-helper-Zf8nSx-t.js";import"./useTranslation-BpQ4WMie.js";import"./index-BwjMLDF7.js";import"./createIconSet-BSIZzTr_.js";function j({todo:t,categories:i,onToggleComplete:e,onUpdateTodo:s,onOpenDeleteModal:r}){const[d,c]=g.useState(!1),[I,B]=g.useState(null),[T,R]=g.useState(!1),[m,N]=g.useState(!1),[V,A]=g.useState(t.title),[q,L]=g.useState(t.description??""),[W,h]=g.useState(t.categoryId??void 0);g.useEffect(()=>{m||(A(t.title),L(t.description??""),h(t.categoryId??void 0))},[m,t.description,t.title,t.categoryId]);const G=()=>{A(t.title),L(t.description??""),h(t.categoryId??void 0),B(null),N(!0)},Q=async()=>{R(!0),B(null);try{await s(t.id,V,q,W||null),N(!1)}catch(u){B(u.message)}finally{R(!1)}},J=()=>{r(t.id,t.title)},X=()=>{N(!1)},Z=u=>{h(W===u?void 0:u)};return n.jsx(p,{onPointerEnter:()=>c(!0),onPointerLeave:()=>c(!1),children:n.jsxs(Y,{className:`mb-1 flex-row rounded-lg border border-transparent p-3 pt-1 hover:border-gray-200 dark:hover:border-gray-700 ${m?"":"active:bg-gray-50 dark:active:bg-gray-700"}`,onPress:()=>{m||e(t.id)},onLongPress:()=>{F.OS!=="web"&&!m&&G()},children:[n.jsxs(p,{className:"flex-1",children:[m&&n.jsxs(p,{className:"my-2 flex-row gap-2",children:[n.jsx(H,{t:"todos.update",type:"primary",size:"small",onPress:Q,className:"px-4",disabled:T,testID:"todo-item-save-button"}),n.jsx(H,{t:"todos.cancel",type:"ghost",size:"small",onPress:X,className:"px-4",disabled:T,testID:"todo-item-cancel-button"}),n.jsx(H,{t:"todos.delete",type:"destructive",size:"small",onPress:J,disabled:T,testID:"todo-item-delete-button"})]}),t.category&&!m&&n.jsxs(p,{className:"-mb-3 ml-6 flex-row items-center px-2 py-1",children:[t.category.icon?n.jsx(w,{className:"mr-1 text-xs",children:t.category.icon}):null,n.jsxs(w,{className:"text-xs font-medium",style:{color:t.category.color||void 0},children:[t.category.name," ",n.jsx(w,{className:"color-gray-400",children:"/"})]})]}),n.jsxs(p,{className:"mt-2 flex-row",children:[!m&&n.jsx(p,{className:`mr-3 mt-1 h-5 w-5 rounded border-2 ${t.completed?"border-blue-600 bg-blue-600":"border-gray-300 dark:border-gray-600"}`,children:t.completed&&n.jsx(w,{className:"text-center text-xs leading-4 text-white",children:"✓"})}),n.jsx(p,{className:"flex-1",children:m?n.jsxs(p,{className:"gap-2",children:[n.jsx(z,{type:"text",placeholder:"todos.title",value:V,onChangeText:u=>A(u),className:"px-3 py-2 text-base",editable:!T,maxLength:220,testID:"todo-item-title-input"}),n.jsx(z,{type:"text",placeholder:"todos.addDetails",value:q,onChangeText:u=>L(u),className:"px-3 py-2 text-sm",editable:!T,multiline:!0,numberOfLines:4,textAlignVertical:"top",testID:"todo-item-description-input"}),i&&i.length>0&&n.jsx(p,{className:"flex-row flex-wrap gap-2",children:i.map(u=>n.jsx(et,{type:"ghost",category:u,selectedCategory:W,setSelectedCategory:Z,disabled:T},u.id))}),n.jsx(tt,{error:I})]}):n.jsxs(n.Fragment,{children:[n.jsx(w,{className:`mt-0.5 text-base font-semibold ${t.completed?"text-gray-500 line-through dark:text-gray-400":"text-gray-900 dark:text-white"}`,children:t.title}),t.description&&n.jsx(w,{className:`mt-1 text-sm ${t.completed?"text-gray-500 dark:text-gray-500":"text-gray-600 dark:text-gray-300"}`,children:t.description})]})})]})]}),!m&&F.OS==="web"&&n.jsx(p,{className:"max-w-10 flex-1 items-center justify-center pt-2",children:n.jsx(Y,{onPress:u=>{u.stopPropagation(),G()},className:"h-6 w-6 items-center justify-center rounded hover:bg-gray-200 active:bg-gray-300 dark:hover:bg-gray-600 dark:active:bg-gray-500",style:{opacity:d?1:0},testID:"todo-item-edit-button",children:n.jsx(nt,{name:"edit",size:18,color:"#6b7280"})})})]})})}j.__docgenInfo={description:"",methods:[],displayName:"TodoItem",props:{todo:{required:!0,tsType:{name:'RouterOutput["todo"]["getAll"][number]',raw:'RouterOutput["todo"]["getAll"][number]'},description:""},categories:{required:!1,tsType:{name:'RouterOutput["category"]["getAll"]',raw:'RouterOutput["category"]["getAll"]'},description:""},onToggleComplete:{required:!0,tsType:{name:"signature",type:"function",raw:"(id: string) => void",signature:{arguments:[{type:{name:"string"},name:"id"}],return:{name:"void"}}},description:""},onUpdateTodo:{required:!0,tsType:{name:"signature",type:"function",raw:"(id: string, title: string, description: string, categoryId?: string | null) => Promise<void>",signature:{arguments:[{type:{name:"string"},name:"id"},{type:{name:"string"},name:"title"},{type:{name:"string"},name:"description"},{type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},name:"categoryId"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},onOpenDeleteModal:{required:!0,tsType:{name:"signature",type:"function",raw:"(id: string, title: string) => void",signature:{arguments:[{type:{name:"string"},name:"id"},{type:{name:"string"},name:"title"}],return:{name:"void"}}},description:""}}};const{expect:a,fn:P,userEvent:o,waitFor:l,within:y}=__STORYBOOK_MODULE_TEST__,v={id:"cat-1",name:"Work",color:"#2563EB",icon:"💼",_count:{todos:3}},U={id:"cat-2",name:"Personal",color:"#DC2626",icon:null,_count:{todos:5}},ot=[v,U,{id:"cat-3",name:"Errands",color:"#047857",icon:"🛒",_count:{todos:2}}],at={id:"todo-1",title:"Buy groceries",description:"Milk, eggs, and bread",completed:!1,categoryId:"cat-1",category:{name:v.name,color:v.color,icon:v.icon}},K={id:"todo-2",title:"Call mom",description:null,completed:!1,categoryId:null,category:null},$={id:"todo-3",title:"Finish report",description:"Q4 Financial Summary",completed:!0,categoryId:"cat-1",category:{name:v.name,color:v.color,icon:v.icon}},it={id:"todo-4",title:"Read a book",description:"At least 30 pages",completed:!1,categoryId:"cat-2",category:{name:U.name,color:U.color,icon:U.icon}},Bt={title:"todos/TodoItem",component:j,tags:["autodocs"],args:{todo:at,categories:ot,onToggleComplete:P(),onUpdateTodo:P(async(t,i,e,s)=>{}),onOpenDeleteModal:P()},decorators:[t=>n.jsx(p,{className:"w-full max-w-md",children:n.jsx(t,{})})],render:t=>{const[i,e]=g.useState(t.todo);return n.jsx(j,{...t,todo:i,onToggleComplete:s=>{e({...i,completed:!i.completed}),t.onToggleComplete(s)}})}},x={play:async({args:t,canvasElement:i})=>{const e=y(i);t.onToggleComplete.mockClear();const s=e.getByText("Buy groceries");await a(s).toBeInTheDocument();const r=e.getByTestId("todo-item-edit-button");await o.hover(s),await l(()=>{a(r.style.opacity).toBe("1")}),await o.unhover(s),await l(()=>{a(r.style.opacity).toBe("0")});const d=e.getByText("Milk, eggs, and bread");await a(d).toBeInTheDocument();const c=e.getByText(/Work/);await a(c).toBeInTheDocument(),await o.click(s),await a(t.onToggleComplete).toHaveBeenCalledTimes(1),await a(t.onToggleComplete).toHaveBeenCalledWith("todo-1")}},b={args:{todo:{...$,category:{...$.category,color:null}}}},E={args:{todo:K}},f={args:{todo:it}},C={play:async({args:t,canvasElement:i})=>{const e=y(i);t.onUpdateTodo.mockClear(),t.onOpenDeleteModal.mockClear();const s=e.getByTestId("todo-item-edit-button");await o.click(s),await l(()=>{const I=e.getByTestId("todo-item-title-input");a(I).toBeInTheDocument()});const r=e.getByTestId("todo-item-title-input"),d=e.getByTestId("todo-item-description-input");await o.clear(r),await o.type(r,"Updated title"),await o.clear(d),await o.type(d,"Updated description");const c=e.getByTestId("todo-item-save-button");await o.click(c),await l(()=>{a(t.onUpdateTodo).toHaveBeenCalledWith("todo-1","Updated title","Updated description","cat-1")})}},k={play:async({args:t,canvasElement:i})=>{const e=y(i);t.onUpdateTodo.mockClear();const s=e.getByTestId("todo-item-edit-button");await o.click(s),await l(()=>{const c=e.getByTestId("todo-item-title-input");a(c).toBeInTheDocument()});const r=e.getByTestId("todo-item-title-input");await o.clear(r),await o.type(r,"Modified title");const d=e.getByTestId("todo-item-cancel-button");await o.click(d),await l(()=>{const c=e.getByText("Buy groceries");a(c).toBeInTheDocument()}),await a(t.onUpdateTodo).not.toHaveBeenCalled()}},D={play:async({args:t,canvasElement:i})=>{const e=y(i);t.onOpenDeleteModal.mockClear();const s=e.getByTestId("todo-item-edit-button");await o.click(s),await l(()=>{const d=e.getByTestId("todo-item-delete-button");a(d).toBeInTheDocument()});const r=e.getByTestId("todo-item-delete-button");await o.click(r),await a(t.onOpenDeleteModal).toHaveBeenCalledWith("todo-1","Buy groceries")}},O={play:async({args:t,canvasElement:i})=>{const e=y(i);t.onUpdateTodo.mockClear();const s=e.getByTestId("todo-item-edit-button");await o.click(s),await l(()=>{const c=e.getByTestId("todo-item-title-input");a(c).toBeInTheDocument()});const r=e.getAllByRole("radio");await a(r.length).toBe(3),await o.click(r[1]);const d=e.getByTestId("todo-item-save-button");await o.click(d),await l(()=>{a(t.onUpdateTodo).toHaveBeenCalledWith("todo-1","Buy groceries","Milk, eggs, and bread","cat-2")})}},M={play:async({args:t,canvasElement:i})=>{const e=y(i);t.onUpdateTodo.mockClear();const s=e.getByTestId("todo-item-edit-button");await o.click(s),await l(()=>{const c=e.getByTestId("todo-item-title-input");a(c).toBeInTheDocument()});const r=e.getAllByRole("radio");await o.click(r[0]);const d=e.getByTestId("todo-item-save-button");await o.click(d),await l(()=>{a(t.onUpdateTodo).toHaveBeenCalledWith("todo-1","Buy groceries","Milk, eggs, and bread",null)})}},S={args:{onUpdateTodo:P(async(t,i,e,s)=>{throw new Error("Failed to update todo")})},play:async({args:t,canvasElement:i})=>{const e=y(i);t.onUpdateTodo.mockClear();const s=e.getByTestId("todo-item-edit-button");await o.click(s),await l(()=>{const c=e.getByTestId("todo-item-save-button");a(c).toBeInTheDocument()});const r=e.getByTestId("todo-item-save-button");await o.click(r),await l(()=>{const c=e.getByText("Failed to update todo");a(c).toBeInTheDocument()});const d=e.getByTestId("todo-item-title-input");await a(d).toBeInTheDocument()}},_={args:{todo:K},render:t=>(Object.defineProperty(F,"OS",{value:"ios",writable:!0,configurable:!0}),n.jsx(p,{children:n.jsx(j,{...t})})),play:async({args:t,canvasElement:i})=>{const e=y(i);try{t.onToggleComplete.mockClear(),t.onUpdateTodo.mockClear();const s=e.queryByTestId("todo-item-edit-button");await a(s).toBeNull();const r=e.getByText("Call mom");await a(r).toBeInTheDocument(),await o.pointer({keys:"[MouseLeft>]",target:r}),await new Promise(B=>setTimeout(B,500)),await o.pointer({keys:"[/MouseLeft]"}),await l(()=>{const B=e.getByTestId("todo-item-title-input");a(B).toBeInTheDocument()});const d=e.getByTestId("todo-item-title-input"),c=e.getByTestId("todo-item-description-input");await a(d.value).toBe("Call mom"),await a(c.value).toBe(""),await o.clear(d),await o.type(d,"Updated via long press"),await o.clear(c),await o.type(c,"Updated description");const I=e.getByTestId("todo-item-save-button");await o.click(I),await l(()=>{a(t.onUpdateTodo).toHaveBeenCalledWith("todo-2","Updated via long press","Updated description",null)})}finally{Object.defineProperty(F,"OS",{value:"web",writable:!0,configurable:!0})}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  play: async ({
    args,
    canvasElement
  }) => {
